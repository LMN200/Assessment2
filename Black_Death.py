...
plt.imshow(population, cmap='Blues')
plt.show()

# Test rats caught data has loaded in and display
# print(rats[0][:10])
plt.imshow(rats, cmap='Reds')
plt.show()
...
#     # popup.focus_set()
#     # the input dialog
#     pop_weight = simpledialog.askstring(title="Population Weighting",
...
#     popup.withdraw()
#     # the input dialog
#     rats_weight = simpledialog.askstring(title="Rats Weighting",
